...
| Carpeta | Contenido |
| --- | --- |
| [`raci/raci.md`](raci/raci.md) | Roles, RACI operativo y cadencia de ceremonias |
| [`gates/gates.md`](gates/gates.md) | Gates G0-G7, criterios BLOCKED e hitos M0-M8 |
| [`risks/risk-register.yaml`](risks/risk-register.yaml) | Registro de riesgos, sembrado con DEP-01..10 |
